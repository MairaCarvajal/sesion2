<%-- 
    Document   : bienvenido
    Created on : 09/09/2024, 8:39:22 p. m.
    Author     : MAIRA
--%>
...
<body>
    <header>
        <h1 class="titulo">Maira Carvajal <span>LibroPresta</span></h1>
    </header>
    <div class="nav-bg">
    ...
    <section class="hero">
        <div class="contenido-hero">
            <h2>Diseño y desarrollo Web <span>LibroPresta</span></h2>
            <div class="ubicacion">
    ...
    <footer class="footer">
        <p>Todos los derechos reservados. Maira Carvajal </p>
    </footer>
